              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    experience. Crafted with high-quality materials and
                    attention to detail, it's perfect for both casual and active
                    wear.
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b pb-4">
                      ...
                      <p className="text-muted-foreground">
                        Excellent quality and very comfortable. Perfect fit and
                    ...
                    <div className="border-b pb-4">
                      ...
                      <p className="text-muted-foreground">
                        Good quality shoe, runs slightly large. Would recommend
                        sizing down.
                      </p>
                    </div>
                  </div>
